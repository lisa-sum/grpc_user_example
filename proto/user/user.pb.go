...
type LoginResponse struct {
	...
	StateCode int32  `protobuf:"varint,1,opt,name=state_code,json=stateCode,proto3" json:"state_code,omitempty"`
	StateMsg  string `protobuf:"bytes,2,opt,name=state_msg,json=stateMsg,proto3" json:"state_msg,omitempty"`
}
...
func (x *LoginResponse) GetStateCode() int32 {
	if x != nil {
		return x.StateCode
	}
	return 0
...
func (x *LoginResponse) GetStateMsg() string {
	if x != nil {
		return x.StateMsg
	}
	return ""
...
func (x *RegisterResponse) GetStateCode() int32 {
	if x != nil {
		return x.StateCode
	}
	return 0
...
func (x *RegisterResponse) GetStateMsg() string {
	if x != nil {
		return x.StateMsg
	}
	return ""
...
var file_protobuf_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x46, 0x0a, 0x0c,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x63,
	0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x43, 0x6f, 0x64, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x6d, 0x73,
	0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x65, 0x4d, 0x73,
	0x67, 0x22, 0x49, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71,
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01,
	...
	0x28, 0x09, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x65, 0x4d, 0x73, 0x67, 0x22, 0x53, 0x0a, 0x04,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x25, 0x0a, 0x06, 0x67, 0x65,
	...
	0x72, 0x2a, 0x25, 0x0a, 0x06, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x07, 0x0a, 0x03, 0x53,
	0x45, 0x58, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x4d, 0x41, 0x4e, 0x10, 0x01, 0x12, 0x09, 0x0a,
	0x05, 0x57, 0x4f, 0x4d, 0x45, 0x4e, 0x10, 0x02, 0x32, 0x7e, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
...
var file_protobuf_user_proto_depIdxs = []int32{
	...
	1, // 1: users.UserService.Login:input_type -> users.LoginRequest
	3, // 2: users.UserService.Register:input_type -> users.RegisterRequest
	2, // 3: users.UserService.Login:output_type -> users.LoginResponse
	4, // 4: users.UserService.Register:output_type -> users.RegisterResponse
